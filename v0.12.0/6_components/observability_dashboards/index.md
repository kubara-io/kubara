...
In Grafana you can also view logs, see [Logs](../6_components/observability_logs.md)

## Alerts in Grafana

In Grafana you can also view alerts, see [alerting](../6_components/observability_alerts.md)
