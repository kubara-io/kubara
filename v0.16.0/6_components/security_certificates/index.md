...
1. **Requirement: working domain**  
   ...
   - Whether you manage DNS records manually or automate them with [ExternalDNS](../6_components/network_external_dns.md) does not matter - what matters is that the domain resolves correctly.
...
- [ExternalDNS](../6_components/network_external_dns.md)  is **not strictly required**.  
- You can manage DNS records manually as long as the domain resolves to the cluster.  
- With [ExternalDNS](../6_components/network_external_dns.md)  it becomes easier, since records are created and updated automatically.  
