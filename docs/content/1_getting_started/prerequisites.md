...
- `kubara` for your OS (Windows, Linux, or macOS) - follow the [installation guide](https://github.com/kubara-io/kubara/blob/main/INSTALLATION.md) or download it from the [releases page](https://github.com/kubara-io/kubara/releases)
