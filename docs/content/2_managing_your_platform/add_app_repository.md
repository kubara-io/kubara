...
To deploy applications with argoCD we need to connect Repositories. This is also useful if you want to give developers
...
If you let argoCD manage itself, it will add the configured repository to your cluster.
