...
The bucket policy grants bucket metadata access, including `HeadBucket`, because S3-compatible clients such as Velero validate the backup bucket before reading or writing objects.
